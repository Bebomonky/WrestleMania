local volcano_extended = {}

function volcano_extended:Create()
	local members = {}
...
function volcano_extended:StartScript(activity)
	self:ScriptData(activity)
end

function volcano_extended:ScriptData(activity)
...
function volcano_extended:UpdateScript(activity)
end

return volcano_extended:Create()